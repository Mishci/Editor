...
const EditorPage = () => { 
          ...
          instance.UI.setHeaderItems(header => {
            header.push({
                ...
                onClick: async () => {
                  ...
                  blobData.append("my blob", blob, "blob.txt")
                  // handling the blob 
                  ...
                  .then(response => {if (response.status === 200) console.log('Connection ok')})
                  .catch(err => alert(err));  
    ...
    return  <div className="webviewer" ref={viewer} style={{height: "100vh", width: "90vw", margin:"auto"}}></div>
